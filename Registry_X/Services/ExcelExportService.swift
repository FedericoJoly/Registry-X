...
class ExcelExportService {
    ...
    private static func createRegistrySheet(event: Event) -> String {
        ...
        for (index, header) in headers.enumerated() {
            xml += "<c r=\"\(columnLetter(index))1\" s=\"1\" t=\"str\"><v>\(xmlEscape(header))</v></c>"
        }
        // Add product columns
        for (index, product) in allProducts.enumerated() {
            ...
            xml += "<c r=\"\(columnLetter(colIndex))1\" s=\"1\" t=\"str\"><v>\(xmlEscape(productHeader))</v></c>"
        }
        xml += "</row>\n"
    ...
    private static func createGroupsSheet(event: Event) -> String {
        ...
        xml += "<row r=\"\(rowNum)\"><c r=\"A\(rowNum)\" s=\"1\" t=\"str\"><v>BY TYPE</v></c></row>\n"
        rowNum += 1
        
        // Header row for categories
        xml += "<row r=\"\(rowNum)\">"
        xml += "<c r=\"A\(rowNum)\" s=\"1\" t=\"str\"><v>Category</v></c>"
        xml += "<c r=\"B\(rowNum)\" s=\"1\" t=\"str\"><v>Total Units</v></c>"
        xml += "<c r=\"C\(rowNum)\" s=\"1\" t=\"str\"><v>Total Amount</v></c>"
        xml += "</row>\n"
        rowNum += 1
        ...
        xml += "<row r=\"\(rowNum)\"><c r=\"A\(rowNum)\" s=\"1\" t=\"str\"><v>BY SUBGROUP</v></c></row>\n"
        rowNum += 1
        
        // Header row for subgroups
        xml += "<row r=\"\(rowNum)\">"
        xml += "<c r=\"A\(rowNum)\" s=\"1\" t=\"str\"><v>Subgroup</v></c>"
        xml += "<c r=\"B\(rowNum)\" s=\"1\" t=\"str\"><v>Total Units</v></c>"
        xml += "<c r=\"C\(rowNum)\" s=\"1\" t=\"str\"><v>Total Amount</v></c>"
        xml += "</row>\n"
        rowNum += 1
